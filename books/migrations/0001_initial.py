# Generated by Django 4.1.4 on 2022-12-11 23:03
            ...
            fields=[
                ...
                (
                    ...
                    books.fields.DeweyField(
                        max_length=28, null=True, validators=[books.validators.DeweyValidator], verbose_name="Dewey"
                    ),
                ),
                ...
                ("volumes", models.CharField(max_length=100, null=True, verbose_name="Volumes")),
                ...
                (
                    ...
                    books.fields.ISBNField(
                        max_length=28, null=True, validators=[books.validators.ISBNValidator], verbose_name="ISBN"
                    ),
                ),
                (
                    "issn",
                    books.fields.ISSNField(
                        max_length=16, null=True, validators=[books.validators.ISSNValidator], verbose_name="ISSN"
                    ),
                ),
                (
                    "ean",
                    books.fields.EANField(
                        max_length=28, null=True, validators=[books.validators.EANValidator], verbose_name="EAN"
                    ),
                ),
