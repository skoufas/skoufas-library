    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "organisation_name",
                    models.CharField(blank=True, max_length=200, null=True, verbose_name="organisation name"),
                ),
                (
                    "romanized_name",
                    models.CharField(blank=True, default="", max_length=1000, verbose_name="romanized name"),
                ),
            ],
            options={
                "verbose_name": "Author",
                ...
                "indexes": [
                    django.contrib.postgres.indexes.GistIndex(
                        fields=["romanized_name"], name="author_romanized_name_gist", opclasses=["gist_trgm_ops"]
                    )
                ],
                "constraints": [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("subtitle", models.CharField(blank=True, max_length=4096, null=True, verbose_name="Subtitle")),
                (
                    "skoufas_classification",
                    books.fields.SkoufasClassificationField(
                        blank=True,
                        max_length=28,
                        null=True,
                        validators=[books.validators.validate_skoufas_classification],
                        verbose_name="Classification",
                    ),
                ),
                (
                    "language",
                    books.fields.LanguageField(
                        blank=True,
                        choices=[
                            ("el", "Modern Greek"),
                            ("en", "English"),
                ...
                ("edition", models.CharField(blank=True, max_length=60, null=True, verbose_name="Edition")),
                (
                    "edition_year",
                    models.IntegerField(
                        blank=True,
                ...
                ("copies", models.IntegerField(blank=True, null=True, verbose_name="Copies")),
                ("volumes", models.CharField(blank=True, max_length=200, null=True, verbose_name="Volumes")),
                ("notes", models.CharField(blank=True, max_length=4096, null=True, verbose_name="Notes")),
                ("material", models.CharField(blank=True, max_length=4096, null=True, verbose_name="Material")),
                (
                    "isbn",
                ...
                (
                    ...
                    books.fields.ISSNField(
                        ...
                        max_length=16,
                        null=True,
                        validators=[books.validators.validate_issn],
                        verbose_name="ISSN",
                    ),
                ),
                (
                    ...
                    books.fields.EANField(
                        ...
                        max_length=28,
                        null=True,
                        validators=[books.validators.validate_ean],
                        verbose_name="EAN",
                    ),
                ),
                ...
                (
                    ...
                    models.IntegerField(
                        blank=True, editable=False, null=True, verbose_name="Skoufas Classification Class"
                    ),
                ),
                (
                    "romanized_title",
                    models.CharField(blank=True, default="", max_length=8192, verbose_name="romanized title"),
                ),
                ("authors", models.ManyToManyField(blank=True, to="books.author", verbose_name="Author")),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ("id", models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name="ID")),
                ("image", models.ImageField(upload_to=books.models._book_entry_image_upload_to, verbose_name="Image")),
                (
                    "image_type",
                    models.CharField(
                        choices=[
            ...
            options={
                "verbose_name": "Book Entry Image",
                "verbose_name_plural": "Book Entry Images",
                "ordering": ["order", "pk"],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    django.contrib.postgres.indexes.GistIndex(
                        fields=["romanized_name"], name="curator_romanized_name_gist", opclasses=["gist_trgm_ops"]
                    )
                ],
                "constraints": [
                    models.UniqueConstraint(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ("id", models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name="ID")),
                ("name", models.CharField(blank=True, max_length=200, null=True, verbose_name="Editor")),
                ("place", models.CharField(blank=True, max_length=200, null=True, verbose_name="Editor place")),
                (
                    "romanized_name",
                    models.CharField(blank=True, default="", max_length=1000, verbose_name="romanized name"),
                ),
            ...
            options={
                ...
                "indexes": [
                    django.contrib.postgres.indexes.GistIndex(
                        fields=["romanized_name"], name="editor_romanized_name_gist", opclasses=["gist_trgm_ops"]
                    )
                ],
                "constraints": [models.UniqueConstraint(fields=("name", "place"), name="unique_editor")],
            },
        ),
        migrations.AddField(
            model_name="bookentry",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "type",
                    models.CharField(
                        choices=[("building", "Building"), ("room", "Room"), ("shelf", "Shelf"), ("box", "Box")],
                        max_length=20,
                        verbose_name="type",
                    ),
                ),
                ("notes", models.TextField(blank=True, null=True, verbose_name="notes")),
                ("non_public", models.BooleanField(default=False, verbose_name="non-public")),
                (
                    "parent",
                    models.ForeignKey(
                        blank=True,
            ...
            options={
                ...
                "ordering": ["name"],
                "permissions": [("view_nonpublic_location", "Can view non-public locations")],
            },
        ),
        migrations.CreateModel(
            name="EntryNumber",
            fields=[
                ("id", models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name="ID")),
                ("entry_number", models.IntegerField(verbose_name="Entry number")),
                ("copies", models.IntegerField(blank=True, default=0, null=True, verbose_name="Copies")),
                (
                    "book_entry",
                    models.ForeignKey(
                ...
                ("entry_number_donors", models.ManyToManyField(blank=True, to="books.donor", verbose_name="Donor")),
                (
                    "location",
                    models.ForeignKey(
                        blank=True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "romanized_topic_name",
                    models.CharField(blank=True, default="", max_length=1000, verbose_name="romanized topic name"),
                ),
            ],
            options={
                "verbose_name": "Topic",
                ...
                "indexes": [
                    django.contrib.postgres.indexes.GistIndex(
                        fields=["romanized_topic_name"], name="topic_romanized_name_gist", opclasses=["gist_trgm_ops"]
                    )
                ],
                "constraints": [models.UniqueConstraint(fields=("topic_name",), name="unique_topic_name")],
            },
        ),
        migrations.AddField(
            model_name="bookentry",
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    django.contrib.postgres.indexes.GistIndex(
                        fields=["romanized_name"], name="translator_romanized_name_gist", opclasses=["gist_trgm_ops"]
                    )
                ],
                "constraints": [
                    models.UniqueConstraint(
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=("dbfentry", "code"), name="unique_dbf_entry_row_code"),
        ),
        migrations.AddConstraint(
            model_name="location",
            constraint=models.UniqueConstraint(
                fields=("name", "parent"), name="unique_location_name_per_parent", nulls_distinct=False
            ),
        ),
        migrations.AddConstraint(
        ...
        migrations.AddIndex(
            ...
            index=django.contrib.postgres.indexes.GistIndex(
                fields=["romanized_title"], name="bookentry_romtitle_gist", opclasses=["gist_trgm_ops"]
            ),
        ),
    ]
